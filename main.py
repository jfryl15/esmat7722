...
if __name__ == "__main__":
    ...
    if server_settings.ssl_certfile and server_settings.ssl_keyfile:
        ...
        if server_settings.uds:
            ...
            # In that environment we must bind to the injected public port instead of forcing localhost.
            is_railway = bool(os.getenv("RAILWAY_ENVIRONMENT") or os.getenv("RAILWAY_PUBLIC_DOMAIN"))
            ip = server_settings.host if is_railway else check_and_modify_ip(server_settings.host)
